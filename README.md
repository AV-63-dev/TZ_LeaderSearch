...
Для того, чтобы пройти на собеседование на должность младшего веб-программиста в «Лидер поиска», нужно сделать тестовое задание. Срок сдачи — до конца 14.03.2021.

До завтрашнего вечера прошу сообщить ответным письмом, будете ли выполнять его или откажетесь. В случае вашего согласия я вышлю доступы к серверу, на котором нужно будет выполнять задание. При желании можно сделать тестовое на своём сервере, где будут использованы удобные для вас технологии. В этом случае мне нужно будет скинуть урл, на котором можно смотреть результат.

В первые 2 месяца работы на испытательном сроке зарплата будет 30000 рублей, после его прохождения на грейде junior она составит от 35000 до 45000 в месяц в зависимости от выработки. После получения грейда middle зарплата увеличится примерно на 60%.
...
Макет «desktop» показывает как будет выглядеть сайт на ширинах 931 пиксель и выше. При уменьшении ширины экрана от 1170 до 931 товарные блоки пропорционально уменьшаются в ширину, показываем по 4 товара в ряд. На более широких экранах ширина контент-части остаётся неизменной, увеличиваются белые поля справа и слева.

Макет «930» показывает, как будет выглядеть сайт при ширинах экрана от 691 до 930 px. При уменьшении ширины экрана от 930 до 691 товарные блоки пропорционально уменьшаются в ширину, показываем по 3 товара в ряд.

Макет «630» для ширин экрана от 511 до 690px. При уменьшении ширины экрана от 690 до 320 товарные блоки пропорционально уменьшаются в ширину, показываем по 1 товару в ряд.
...
Для разрешений свыше 691px при наведении мышкой на карточку товара название и цена подъезжают выше, снизу появляется кнопка «добавить в корзину», как это показано в uikit. Для ширин экранов 690px и ниже кнопки появляются сразу для всех карточках товаров. После нажатия на эту кнопку, плашка кнопки становится зелёной, надпись меняется на «В корзине» и рядом со значком корзины появляется кружочек, в нём цифра добавленных в корзину товаров.
...
Свёрстано должно быть по макету, pixelperfect в помощь.

Готов ответить на возникшие вопросы и желаю удачи!
